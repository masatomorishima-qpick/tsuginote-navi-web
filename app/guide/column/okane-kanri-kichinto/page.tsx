...
const PAGE_DESCRIPTION =
  'ネット銀行・NISA・ペーパーレス——正しい管理ほど、家族からは「見えない資産」になる。きちんとしている人だけに起きる副作用を、公的な数字と相談事例から解き明かし、金額もパスワードも書かない「資産の地図」という15分の備え方までを解説します。';
...
const toc = [
  ...
  { id: 'map', label: '答えは、「地図」を残すこと' },
  { id: 'faq', label: 'よくある4つの疑問' },
  { id: 'keep', label: '地図は「作って終わり」にしないことが大切' },
];

const faqs = [
  {
    q: '相続の制度があるから、最後は何とかなるのでは？',
    a: '制度はあります。ただ、この記事で見た通り、銀行は一行ずつの照会、証券はほふりへの開示請求（6,050円・約1か月・判明するのは証券会社名まで）という手間と費用が、悲しみの中の家族に乗ります。そして何より、すべての制度は「家族が、資産の存在を疑って、探し始めること」が出発点です。地図はその出発点を、丸ごと省略してあげるものです。',
  },
  {
    q: '夫婦でお金の話はしているから、うちは大丈夫では？',
    a: '素晴らしいことです。では、2つだけ確認を。配偶者は、あなたの口座を「全部」言えますか？　昔の給与口座や、キャンペーンで作った口座まで含めて。そしてもうひとつ——その共有、最後に更新したのはいつですか？　口座もNISAも増えたり変わったりします。口頭の共有は、時間とともに地図ではなく「古い地図」になります。特に、お互いが自立して資産を運用している共働きの夫婦ほど、注意が必要です。「相手もきちんとしているから」という信頼があるからこそ、あえて相手の財布には踏み込まない。家庭円満の知恵ですが、この距離感がそのまま死角になります。お互いの管理能力が高い夫婦ほど、お互いの資産の「在りか」を知らない——記事全体でお話ししてきた逆説は、夫婦の間でも起きるのです。',
  },
  {
      ...
      <div className="mx-auto max-w-3xl px-5 pb-20 pt-8 sm:px-8">
        ...
        <Section id="reason3" title="理由3：家族は、「ない」ことすら確かめられない">
          ...
          <p>
            ...
            。優れた機能ですら、最初の入り口となる「地図」がなければ届かないのです。
          </p>
          ...
          <p>
            ...
            のです。相続を放棄するかどうかの判断は、原則として相続を知ってから3か月以内。相続税の申告と納付は10か月以内。資産の全体像がつかめないと、「相続すべきか・放棄すべきか」の判断も、税金の計算もできません。終わりの見えない探し物を、締め切りに追われながらやる——これが、地図を持たない家族に課される仕事です。
          </p>
          <p>
        ...
        <Section id="map" title="答えは、「地図」を残すこと">
          <p>
          ...
          <p>
            その具体的な形が、<strong>資産の「地図」を残すこと</strong>。これだけです。
          </p>
          <div className="overflow-hidden rounded-2xl">
            <Image
              src="/images/guide/column/okane-kanri-kichinto-chizu.webp"
              alt="ノートに金融機関の名前だけを書き出して、資産の「地図」を作っている手元"
              width={1600}
              height={900}
              className="h-auto w-full"
            />
          </div>
          <p>地図に書くのは、「どこに・何があるか」だけ。</p>
          ...
          <p>
            ...
            これでほぼ網羅できます。ついでに「ほぼ使っていない口座」が見つかったら、生きているうちに自分で解約しておくと、地図はもっとシンプルになります。
          </p>
          <p>
            そして、地図には「見直し日」をひとつ決めておきましょう。誕生日でも、年末の大掃除でも、NISAの年間投資額を確認するタイミングでも構いません。口座は増えたり減ったりするので、年に1回の数分のメンテナンスで、地図は「古い地図」にならずに済みます。
          </p>
          <p>
            完成した地図の置き場所も、大げさに考える必要はありません。立派なエンディングノートを買わなくても、通帳ケースや保険証券のファイルの底に1枚挟んでおく。あるいは「もしものときは、これを見て」と一言添えて、家族のLINEに画像を送っておく。金額もパスワードも書いていない地図ですから、これくらい軽い渡し方で十分です。重く切り出す必要がないことこそ、「金額を書かない地図」の一番の利点なのです。
          </p>
          <p>
            投資を家族にどう伝えるか迷っている方は、
        ...
        <Section id="keep" title="地図は「作って終わり」にしないことが大切">
          <p>
            最後にひとつだけ。紙の地図にも弱点があります。口座は増えたり減ったりするので内容がすぐ古くなること。そして、家族がその紙の存在と置き場所を知らなければ、結局見つけてもらえないことです。
          </p>
          <p>
        ...
        <section className="mt-14 rounded-3xl bg-slate-50 p-8 text-center sm:p-10">
          <h2 className="text-xl font-semibold text-slate-900">
            資産の「地図」を、もしものときだけ届く形で残すなら
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-[15px] leading-8 text-slate-600">
            「つぎの手ナビ
            デジタル資産」は、口座やNISAなどの在りかを、生きている間は誰にも見せず、もしものときだけ選んだ人へ届ける準備ができるサービスです。登録・PDF出力・定期リマインドは無料で使えます。
          </p>
          <div className="mt-6">
            <GuideCtaLink
