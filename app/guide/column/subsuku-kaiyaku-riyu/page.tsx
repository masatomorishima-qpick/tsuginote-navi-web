  ...
  '@graph': [
    {
      ...
      datePublished: '2026-06-11T09:00:00+09:00',
    ...
    <main className="bg-white">
      ...
      <div className="mx-auto max-w-3xl px-5 pb-20 pt-8 sm:px-8">
        ...
        <Section id="keep" title="一覧は「作って終わり」にしないことが大切">
          ...
          <p>
            それぞれに良さがあるので、まずはどれでも構いません。「ないより、ずっといい」からです。その上で、こうしたデジタルの契約やパスワードといった「デジタル資産」を、ふだんは誰にも見せずに整理しておき、もしものときにだけ、自分が選んだ家族へ引き継げるようにする専用のサービスもあります。
          </p>
          <p>
