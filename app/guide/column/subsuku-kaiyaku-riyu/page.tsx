...
const faqs = [
  {
    ...
    a: '一覧は「もしものとき、家族が困らないために必要なもの」だけで構いません。すべてを書く義務はありませんし、生きている間に家族へ見せるかどうかも、あなたが決めることです。大切なのは、家族が困る二大要素——「お金が流れ続ける契約」と「資産のある場所」——の地図を残すこと。そこさえ押さえれば、目的は果たせます。',
  },
  {
      ...
      <div className="mx-auto max-w-3xl px-5 pb-20 pt-8 sm:px-8">
        ...
        <Section id="reason2" title="理由2：「やめます」と言えるのは、世界であなた一人だけ">
          ...
          <p>
            ...
            ことがあるのです。遺された側は、こうした落とし穴の地図を持たないまま、悲しみの中を手探りで歩くことになります。
          </p>
        </Section>
        ...
        <Section id="answer" title="では、本当に全部解約すべきなのか">
          ...
          <p>
            ...
            <strong>地図がないから</strong>。だったら、地図を残せばいい。
          </p>
          ...
          <p>
            ...
            家族に必要なのは金庫の中身ではなく、<strong>契約が存在することの分かる地図</strong>
        ...
        <section className="mt-14 rounded-3xl bg-slate-50 p-8 text-center sm:p-10">
          ...
          <p className="mx-auto mt-4 max-w-xl text-[15px] leading-8 text-slate-600">
            「つぎの手ナビ
            デジタル資産」は、サブスクや口座などの契約を、生きている間は誰にも見せず、もしものときだけ選んだ人へ届ける準備ができるサービスです。登録・PDF出力・定期リマインドは無料で使えます。
          </p>
          <div className="mt-6">
            <GuideCtaLink
