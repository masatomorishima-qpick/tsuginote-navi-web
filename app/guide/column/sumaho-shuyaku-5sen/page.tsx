    ...
    <main className="bg-white">
      ...
      <div className="mx-auto max-w-3xl px-5 pb-20 pt-8 sm:px-8">
        ...
        <Section id="core" title="ここまでの5つに、共通するひとつの性質">
          ...
          <p>
            便利さと引き換えに、「家族が代わりに開ける」入口が、静かに消えました。もしものとき——急な入院や事故などで、あなたが自分でスマホを開けられなくなったとき——家族は、どのアプリにお金があり、どこと契約しているのかに、たどり着けるでしょうか。開かないスマホの前で、立ち止まってしまうかもしれません。
          </p>
        </Section>
        ...
        <Section id="matome" title="まとめ——軽くなった荷物に、一覧を1枚">
          ...
          <p>
            こうしたお金や契約、写真の在りかを、ふだんは誰にも見せず、もしものときにだけ選んだ家族へ届くようにしておく専用のサービスもあります。
          </p>
