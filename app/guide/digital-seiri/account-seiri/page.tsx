    ...
    <main className="bg-white">
      ...
      <div className="mx-auto max-w-3xl px-5 pb-20 pt-8 sm:px-8">
        ...
        >
          ...
          <p>
            もし、あなたが急に入院したら。事故や病気で、しばらくスマホを触れなくなったら。家族は、どのサービスに何があるのか、たどり着けるでしょうか。どこから手をつければいいのか、知るすべもありません。ネット銀行やネット証券は紙の通知が届かず、有料サービスは止めない限り請求が続きます。実際、大切な方を亡くした人の約7割が「生前に整理してくれていたら助かった」と答えています（2026年 BlueAdventures調べ）。
          </p>
          <p>
            せっかく作った一覧です。
            <strong>
              中身は見せなくていいので、「この一覧がある」ということだけ、もしものときに信頼できる人へ届く形にしておく
            </strong>
