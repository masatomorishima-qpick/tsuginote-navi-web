    ...
    <main className="bg-white">
      ...
      <div className="mx-auto max-w-3xl px-5 pb-20 pt-8 sm:px-8">
        ...
        <Section id="step3" title="ステップ3｜サブスク・定期課金を見直す（ここが効きます）">
          ...
          <p>この見直しを一度やるだけで、月数千円・年数万円が浮くことも珍しくありません。</p>
        </Section>
        ...
        <Section id="finish" title="デジタル断捨離の仕上げ｜「捨てる」から「残す」へ">
          ...
          <p>
            解決の方向はシンプルです。
            <strong>
              全部を見せる必要はなく、「どこに何があるか」という在りかだけを、生きている間は誰にも見せず、もしものときだけ信頼する人に届く形にしておく。
            </strong>{' '}
            これがデジタル断捨離の本当の仕上げです。
          </p>
          <p>
        ...
        <Section id="summary" title="まとめ｜「減らす・整える」のあとに「残す」を一手">
          ...
          <p>
            そして仕上げは、整理した情報の「在りか」を、生きている間は誰にも見せず、もしものときだけ信頼できる人に届く形で残しておくこと。ここまでやって、デジタル断捨離は本当に完成します。
          </p>
        </Section>
