      ...
      <div className="mx-auto max-w-3xl px-5 pb-20 pt-8 sm:px-8">
        ...
        <Section id="saving" title="どれくらい浮く？">
          <p>
            ...
            になるケースは普通にあります。1時間の見直しとしては、かなり割のいい作業です。
          </p>
        </Section>
        ...
        <Section id="blindspot" title="その契約一覧、止められるのはあなただけです">
          ...
          <p>
            もし、あなたが急に入院したら。事故や病気で、しばらくスマホを触れなくなったら。家族は「何を契約しているか」に、たどり着けるでしょうか。たどり着けなければ、サブスクもキャリアオプションも、解約されない限り請求が続きます。ネット銀行やネット証券と同じで、スマホの中の契約は、本人以外には見えないのです。実際、デジタル関連で困った経験のある遺族は約6割にのぼり、その最多が「パスワードが分からず手が出せない」ことでした（2026年 BlueAdventures調べ）。
          </p>
          <p>
            だから、整理の仕上げにもう一手。
            <strong>
