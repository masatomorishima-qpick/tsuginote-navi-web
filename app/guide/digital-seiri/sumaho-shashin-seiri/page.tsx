    ...
    <main className="bg-white">
      ...
      <div className="mx-auto max-w-3xl px-5 pb-20 pt-8 sm:px-8">
        ...
        <Section id="blindspot" title="整理した写真、いざというとき家族は取り出せますか？">
          ...
          <p>
            GoogleフォトもiCloudも、ログインできるのはあなただけ。もしあなたが急に入院したら、事故や病気でスマホを触れなくなったら——家族は、何千枚もの思い出に、一枚でもたどり着けるでしょうか。きれいに整理してまとめたからこそ、その写真は「あなたのアカウントの中だけ」に最適化されています。これは、整理が上手な人ほど起きやすい盲点です。
          </p>
          <p>
