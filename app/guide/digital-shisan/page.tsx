...
const faqs = [
  ...
  },
  {
    ...
    a: 'それは「玄関の鍵」を渡しただけの状態です。スマホが開いても、どのサービスに何があるかは一つずつ探さなければ分かりません。必要なのは鍵そのものより、「どこに何があるか」の地図です。',
  },
];
      ...
      <div className="mx-auto max-w-3xl px-5 pb-20 pt-8 sm:px-8">
        ...
        <Section id="howto" title="デジタル資産の整理・棚卸しのやり方">
          ...
          <p>
            ...
            家族が困るのは「いくらあるか」ではなく「どこにあるか」だからです。この一覧が、いわば資産の「地図」になります。作り方は
          ...
          <p>
            ついでに「ほぼ使っていない口座・サブスク」が見つかったら、生きているうちに自分で解約しておくと、地図はもっとシンプルになります。
          </p>
        </Section>
