  ...
  '@graph': [
    {
      ...
      dateModified: '2026-06-11T09:00:00+09:00',
      inLanguage: 'ja',
      author: {
        '@type': 'Organization',
        name: 'つぎの手ナビ',
    ...
    <main className="bg-white">
      ...
      <div className="mx-auto max-w-3xl px-5 pb-20 pt-8 sm:px-8">
        ...
        <Section id="blindspot" title="ここまでの整理と、最後の盲点">
          ...
          <p>
            パスワード管理アプリのマスターパスワード、各サービスの強固なパスワード、二段階認証のスマホ——これらは「本人以外に開けない」ように設計されています。それがセキュリティの本質です。でも裏を返せば、もしあなたが急に入院したら、事故や病気でスマホを触れなくなったら、家族は、ネット銀行やサブスクに、たどり着けるでしょうか。実際、大切な方を亡くした人がデジタル関連で最も困ったのは「スマホ・パソコンのパスワードが分からない」ことでした（2026年 BlueAdventures調べ）。
          </p>
          <p>
        ...
        <Section id="finish" title="仕上げ｜「鍵そのもの」ではなく「鍵の在りか」を残す">
          <p>
            解決の方向はシンプルです。
            <strong>
              マスターパスワードそのものを今すぐ家族に教える必要はありません。「どこに、何の備えがあるか」という在りかだけを、生きている間は誰にも見せず、もしものときだけ信頼できる人に届く形にしておく。
            </strong>
          </p>
          <p>
