    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-8 sm:px-6">
        ...
        <section id="dont">
          ...
          {/* 2026-08-03 追加：記事9（退職金の受け取り方）への相互参照（駅1指示書5-1）。
              既存の本文・数値・見出しは変更していない。dateModified も更新しない。 */}
          <p className={p}>
            → 退職金でまとまった返済を考えている場合は、その前に受け取り方の判断があります。
            <Link href="/retirement/taishokukin-uketorikata" className={linkCls}>「退職金は一時金と年金どっちで受け取るか」</Link>で扱っています。
          </p>
        </section>
