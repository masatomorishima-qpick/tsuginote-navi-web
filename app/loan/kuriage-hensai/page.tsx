...
const FAQS: Faq[] = [
  ...
  },
  {
    ...
    a: '住宅ローン控除には償還期間10年以上という要件があるため、控除が受けられなくなる場合があります。判定は契約内容によって異なるため、実行前に借入先または税務署に確認してください。返済期間が変わらない返済額軽減型を選べば、この問題は生じません。',
  },
  {
    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-8 sm:px-6">
        ...
        <section id="short-period">
          ...
          <p className={p}>
            控除の残り期間と残高によっては、失う控除額が繰り上げ返済で減らせる利息を上回ることがあります。判定は契約内容によって異なるため、<strong>大幅な期間短縮を伴う繰り上げ返済を検討している場合は、実行する前に借入先の金融機関または税務署に確認してください。</strong>返済額軽減型を選べば返済期間は変わらないため、この問題は生じません。
          </p>
        </section>
