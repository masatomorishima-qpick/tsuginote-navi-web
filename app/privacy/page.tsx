      ...
      <main className="flex-1">
        <section className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-14">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-600 sm:text-base">
            ...
            老後のお金の受け取りシミュレーション（有料版）は第15条に、それぞれ個別事項を定めます。
          ...
          <div className="mt-10 space-y-10 text-sm leading-7 text-slate-700 sm:text-base">
            <section>
              ...
              <p className="mt-3">
                ...
                デジタル資産機能、資産づくり診断、老後のお金の受け取りシミュレーション（有料版）で取得する情報は、第13条〜第15条に定めます。
              </p>
              <p className="mt-3">
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900">
                15. 老後のお金の受け取りシミュレーション（有料版）における情報の取扱い
              </h2>
              <p className="mt-3">
                老後のお金の受け取りシミュレーション（/retirement/pro）は、登録不要でご利用いただけます。
