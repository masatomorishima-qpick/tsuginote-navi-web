      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-8 sm:px-6">
        ...
        <section id="cautions">
          ...
          {/* 2026-08-05 追加：記事13（早期退職の割増退職金）への相互参照（駅1-5指示書4章・追補E）。
              この記事にとって最初の独立した相互参照段落になる（記事11へのリンクは上の <ul> の中）。
              「当てはめないでください」→「では早期退職はどこか」という流れになる位置（masato確定）。
              既存の本文・数値・見出しは変更していない。dateModified も更新しない。 */}
          <p className={p}>
            → 早期退職で辞める場合は、勤続年数が短くなるぶん退職所得控除も減ります。割増を含めた手取りの比べ方は
            <Link href="/retirement/souki-taishoku-warimashi" className={linkCls}>「早期退職の割増退職金は、手取りでいくら残るかで比べます」</Link>
            で扱っています。
          </p>
        </section>
