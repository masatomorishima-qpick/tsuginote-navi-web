  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-8 sm:px-6">
        ...
        {/* 記事9の数字との違い（本文131〜142行目）。見出し・表のセル・本文に置換④⑤⑥を適用済み。
            表のセル（⑤）はリンクにしない：本文にリンク記法がなく、5行下の本文（150行目相当）に
            すでに記事9へのリンクがあり近接して重複するため（追補①・masato確定）。 */}
          ...
          <TableScroll>
            <table className={tableCls}>
              <thead>
                <tr>
                  <th className={thCls}></th>
                  <th className={thCls}>何を表す数字か</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className={tdCls}>「退職金は一時金と年金どっちで受け取るか」の『全額年金の手取り <strong>2,019万円</strong>』</td>
                  <td className={tdCls}>公的年金を受け取っている人が、退職金を<strong>年金で受け取ることによって手元に増える額</strong>。一時金・年金・併用のどれを選ぶかを比べるための量です</td>
                </tr>
                <tr>
                  <td className={tdCls}>この記事の「生涯の手取り」</td>
                  <td className={tdCls}>企業年金と老齢年金を合わせて、<strong>想定した年齢まで受け取った合計</strong>です</td>
                </tr>
              </tbody>
            </table>
          </TableScroll>
