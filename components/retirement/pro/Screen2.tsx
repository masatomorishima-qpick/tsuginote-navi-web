    ...
    <div ref={rootRef}>
      ...
      */}
      <div className="mt-5 rounded-xl bg-slate-50 p-4 sm:p-5">
        ...
        <p className={`mt-2 ${CHU}`}>
          ※この計算は、あなたが「退職所得の受給に関する申告書」を、退職金などを支払う側（勤め先など）に提出することを前提にしています。提出しない場合は、受け取る額の20.42%が所得税として差し引かれます（所得税法201条3項・復興特別所得税を含みます）。この場合も、確定申告をすれば、最終的に納める税額はこの計算と同じになります。変わるのは、受け取るときに差し引かれる額と、確定申告を済ませるまでの期間だけです。
          <br />
