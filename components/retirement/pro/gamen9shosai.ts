 ...
 *
 * もと: bin/senjutsu/tsuginote_gamen_base.html（177,095バイト ／ md5 e67ed20d33f32f94a6b58e9e4fe233d4）
 */
...
export const GAMEN9shosai: readonly Block9shosai[] = [
  ...
  { kind: 'ret', koumoku: [
    { bun: "軽減が{keigen_a}から{keigen_b}に下がる {sakaime_1}", na: ["keigen_a","keigen_b","sakaime_1"] },
    { bun: "{keigen_b}から{keigen_c} {sakaime_2}", na: ["keigen_b","keigen_c","sakaime_2"] },
  ...
  { kind: 'hyo', gyou: [
    ...
    { cells: ["国民健康保険料などの軽減\n基準 {kokuho_kijun}","{a_kokuho_bun}","{b_kokuho_bun}"],
      ...
      kazari: [[null,"tbls"],[null],[null]] },
    { cells: ["住民税の非課税\n基準 {hikazei_gendo}","{a_jumin_bun}","{b_jumin_bun}"],
      na: ["hikazei_gendo","a_jumin_bun","b_jumin_bun"],
      kazari: [[null,"tbls"],[null],[null]] },
  ] },
  { kind: 'hon', bun: "{handan_b_bun}、こうなります。", na: ["handan_b_bun"] },
  { kind: 'ret', koumoku: [
    { bun: "国民健康保険料などの軽減　軽減が{keigen_a}から{keigen_b}に下がります", na: ["keigen_a","keigen_b"] },
