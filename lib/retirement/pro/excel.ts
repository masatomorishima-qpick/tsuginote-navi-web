 ...
 */
const KARA_NO_ATSUKAI: Record<string, string> = {
  ...
  // ★㉑は、配偶者がいらっしゃるときは必須の欄です（★空のままでは入口で止まります）。
  //   ★ここに出るのは、配偶者がいらっしゃらないと答えられた方だけです（paidRules.ts 591〜594行）
  '㉑': '配偶者がいらっしゃらないため、この欄は使っていません',
