...
export function gamen8Bun(
  ...
  return {
    ...
    fileNakami: [
      ['1　結果のまとめ',
       'この画面と同じ内容（あなたの受け取り方・増える税金・確定申告で戻る額・手取り・保険料・医療費）'],
      ['2　受け取り方の一覧',
    ...
    // ★★決め1223 …… ★基準HTML 892行から1字1句写しました（★1行に1つの文）
    nokoranai: [
