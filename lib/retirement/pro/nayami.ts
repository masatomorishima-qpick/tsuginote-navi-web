...
export const NAYAMI_MIDASHI = "受け取り方で迷いやすい3つのこと";

/** 見出しの直後のリード文（★`data-block-start="seido"`・全員に出ます。★2026-09-23・決め1415 の回） */
export const NAYAMI_SEIDO = "退職金と年金の決まりは、ここ数年、たびたび変わっています。どの受け取り方があなたに合うのかを、ご自身で確かめるのは難しくなっています。";
...
export const NAYAMI_KADO: readonly NayamiKado[] = [
  {
    ...
    ji: "何年ずらせば枠を2回使えるかは、あなたの受け取る順番と年によって変わります。",
  },
  {
    ...
    ji: "どの受け取り方なら上がらないかは、あなたの収入と年齢によって変わります。",
  },
  {
    ...
    ji: "組み合わせは数万通りになることもあり、一つずつ手で比べるのは現実的ではありません。",
  },
];
